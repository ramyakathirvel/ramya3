...
def Transaction_amount_count_Y_Q(df, quarter):
    ...
    with col2:
        fig_india_2=px.choropleth(tacyg, geojson= data1, locations="States", featureidkey= "properties.ST_NM",
                                color= "Transaction_count", color_continuous_scale= "Rainbow",
                                range_color=(tacyg["Transaction_count"].min(), tacyg["Transaction_count"].max()),
                                hover_name= "States", title= f"{tacy['Years'].min()} YEAR {quarter} QUARTER TRANSACTION_COUNT", fitbounds= "locations",
                                height= 600,width= 600)
        fig_india_2.update_geos(visible= False)
        st.plotly_chart(fig_india_2)
...
def Top_insurance_plot_1(df, state):
    ...
    with col1:
        fig_top_insur_bar_1= px.bar(tiy, x= "Quarter", y= "Transaction_amount", hover_data= "Pincodes",
                            title= "TRANSACTION AMOUNT", height= 650,width= 600, color_discrete_sequence= px.colors.sequential.Plasma)
...
def top_user_plot_2(df, state):
    ...
    fig_top_plot_2= px.bar(tuys, x= "Quarter",  y= "RegisteredUsers", title= "REGISTEREDUSERS, PINCODES, QYARTER",
...
def top_chart_appopens(table_name, state):
    ...
    col1,col2= st.columns(2)
    with col1:
        fig_amount= px.bar(df_1, x="districts", y="appopens", title= "TOP 10 OF REGISTERED APPOPENS", hover_name= "districts",
                        color_discrete_sequence=px.colors.sequential.Aggrnyl, height= 650,width= 600)
        st.plotly_chart(fig_amount)
...
if select == "HOME":
    ...
    with col2:
        st.image(Image.open(r"C:\Users\ELCOT\Desktop\project\download.png"),width= 600)

    col3,col4= st.columns(2)
    
    with col3:
        st.image(Image.open(r"C:\Users\ELCOT\Desktop\project\download.jpg"),width=600)
    ...
    with col6:
        st.video(r"c:\Users\ELCOT\Downloads\Y2meta.app-Phone Pe Ad-(720p60).mp4")
    ...
    question= st.selectbox("Select the Queastion",["1. Transaction Amount and Count of Aggregated Insurance",
